...
<section class="font-display bg-background-light dark:bg-background-dark text-[#1A1A1A] dark:text-gray-200 py-8">
  <div class="container mx-auto px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
      ...
      <article class="lg:col-span-2">
        ...
        <div class="flex flex-wrap gap-2 mb-4">
          ...
          <span class="text-gray-500 dark:text-gray-400 text-sm font-medium leading-normal">/</span>
          <span class="text-[#1A1A1A] dark:text-gray-200 text-sm font-medium leading-normal truncate max-w-xs">
            {{ $noticia->titulo }}
          </span>
        </div>
        ...
        @if($noticia->bajada)
          <p class="mt-1 mb-4 text-lg text-gray-700 dark:text-gray-300">
            {{ $noticia->bajada }}
          </p>
        @endif
        ...
        {{-- CUERPO DE LA NOTICIA (HTML editable) --}}
        ...
        <div class="mt-10 pt-6 border-t border-gray-200 dark:border-gray-700">
          <h3 class="text-lg font-bold text-[#1A1A1A] dark:text-gray-200 mb-4">Compartir noticia</h3>
          <div class="flex items-center gap-4">
            <a href="#"
               class="flex items-center justify-center size-10 bg-primary/10 text-primary rounded-full hover:bg-green-500 hover:text-white transition-colors duration-200">
              {{-- Facebook --}}
            ...
            <a href="#"
              ...
              <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path
                  d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.71v.053a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84">
                </path>
              </svg>
            </a>
            <a href="#"
        ...
        <div>
          ...
          <div class="space-y-6">
            @forelse($relacionadas ?? [] as $rel)
              <a href="{{ route('noticias.show', $rel->slug) }}" class="group block">
                <div
                  class="overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-all duration-300 group-hover:border-green-500 group-hover:shadow-md">
                  ...
                  <div class="p-4">
                    <h3
                      class="font-bold text-[#1A1A1A] dark:text-gray-200 leading-snug group-hover:text-primary dark:group-hover:text-blue-200">
                      {{ $rel->titulo }}
                    </h3>
