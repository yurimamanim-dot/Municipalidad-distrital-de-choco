...
@section('content')
<div class="bg-white">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 space-y-10">
        ...
        <section>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article
                    ...
                    <div>
                        <div class="w-36 h-36 mx-auto rounded-full border-4 border-primary bg-center bg-cover bg-no-repeat"
                             data-alt="Fotografía de Lucía Mendoza Rojas"
                    ...
                    <div class="space-y-2 flex-1 flex flex-col">
                        ...
                        <p class="text-primary text-sm md:text-base font-medium">
                            Alcaldesa
                        </p>
                ...
                <article
                    class="flex flex-col gap-4 text-center bg-white rounded-xl border border-gray-200 p-6 shadow-sm
                           hover:shadow-lg hover:-translate-y-1 transition-all duración-200">
                    <div>
                        <div class="w-36 h-36 mx-auto rounded-full border-4 border-primary bg-center bg-cover bg-no-repeat"
                             data-alt="Fotografía de Carlos Benavides Solano"
                ...
                <article
                    ...
                    <div>
                        <div class="w-36 h-36 mx-auto rounded-full border-4 border-primary bg-center bg-cover bg-no-repeat"
                             data-alt="Fotografía de Ricardo Palma Gutiérrez"
                ...
                <article
                    ...
                    <div>
                        <div class="w-36 h-36 mx-auto rounded-full border-4 border-primary bg-center bg-cover bg-no-repeat"
                             data-alt="Fotografía de Sofía Torres del Valle"
                ...
                <article
                    ...
                    <div>
                        <div class="w-36 h-36 mx-auto rounded-full border-4 border-primary bg-center bg-cover bg-no-repeat"
                             data-alt="Fotografía de Alberto Ríos Cárdenas"
                ...
                <article
                    ...
                    <div>
                        <div class="w-36 h-36 mx-auto rounded-full border-4 border-primary bg-center bg-cover bg-no-repeat"
                             data-alt="Fotografía de Elena Vásquez Flores"
