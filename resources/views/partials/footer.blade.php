    ...
    <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="col-span-1 lg:col-span-2">
        <div class="mb-4 flex items-center gap-4 text-white">
          {{-- Corrección: Usar asset() para el logo --}}
          <img alt="Logo Municipalidad" class="h-14 w-12" 
        ...
        <div class="flex gap-4">
            <a href="https://www.facebook.com/Choco.municipalidad" target="_blank" 
               class="hover:text-secondary hover:-translate-y-1 transition-transform"
               aria-label="Facebook">
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm text-gray-300">
          <li>
            <a class="hover:text-secondary transition-colors" href="{{ route('inicio') }}">
              Inicio
            </a>
          </li>
          <li>
            <a class="hover:text-secondary transition-colors" href="{{ route('la-municipalidad') }}">
              La Municipalidad
            </a>
          </li>
          <li>
            <a class="hover:text-secondary transition-colors" href="{{ route('noticias.index') }}">
              Noticias y Eventos
            </a>
          </li>
          <li>
            <a class="hover:text-secondary transition-colors" href="{{ route('mesa') }}">
