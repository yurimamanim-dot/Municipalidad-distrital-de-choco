<header class="sticky top-0 z-50 w-full bg-white shadow-md">
  ...
  <div class="bg-primary text-white">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-1 text-xs md:px-10">
      ...
      <div class="flex items-center gap-3">
        <a aria-label="Facebook" class="text-white hover:text-secondary transition-colors" href="#"><svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path clip-rule="evenodd" fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg></a>
        <a aria-label="Twitter" class="text-white hover:text-secondary transition-colors" href="#"><svg class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.71v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path></svg></a>
        <a aria-label="YouTube" class="text-white hover:text-secondary transition-colors" href="#"><svg class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path clip-rule="evenodd" fill-rule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.78 22 12 22 12s0 3.22-.42 4.814a2.506 2.506 0 0 1-1.768 1.768c-1.594.42-7.812.42-7.812.42s-6.218 0-7.812-.42a2.506 2.506 0 0 1-1.768-1.768C2 15.22 2 12 2 12s0-3.22.42-4.814a2.506 2.506 0 0 1 1.768-1.768C5.782 5 12 5 12 5s6.218 0 7.812.418ZM15.194 12 10 15V9l5.194 3Z"/></svg></a>
      </div>
    </div>
  </div>
  ...
  <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-10">
    ...
    <nav class="hidden items-center gap-6 lg:flex">
      <a class="text-sm font-semibold text-primary hover:text-secondary" href="{{ route('home') }}">Inicio</a>
      <a class="text-sm font-medium text-gray-600 hover:text-secondary" href="#">La Municipalidad</a>
