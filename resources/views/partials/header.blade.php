<header class="sticky top-0 z-50 w-full bg-white shadow-md">
  ...
  <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-10">
    ...
    <div class="flex items-center gap-4">
      ...
      <a href="#" class="flex min-w-[84px] items-center justify-center rounded-full h-10 px-6 bg-secondary text-white text-sm font-bold tracking-wide transition-transform hover:scale-105">
